...
public class Pagination extends JdbcDaoSupport {
    ...
    public Pagination(String sql, Object[] params, PageParam pageParam, JdbcTemplate jTemplate) {
        if (jTemplate == null) {
            throw new IllegalArgumentException("ex.aaronfae.util.Pagination.jTemplate is null,please initial it first. ");
        } else if (sql == null || sql.equals("")) {
            throw new IllegalArgumentException("ex.aaronfae.util.Pagination.sql is empty,please initial it first. ");
        }
        //设置每页显示记录数
